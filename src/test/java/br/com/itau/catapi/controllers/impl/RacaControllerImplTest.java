...
public class RacaControllerImplTest {
    ...
    public void deveRetornarUmaRacaTest() throws Exception {
        ...
        BDDMockito.given( racaService.buscarPeloTemperamento(temperamento) ).willReturn( racas );

        // Ação
        MockHttpServletResponse response = mvc.perform(
                MockMvcRequestBuilders
                        .get(API + "/" + temperamento)
        ...
        assertThat( response.getContentAsString() )
                .isEqualTo( jsonResponse.write( racas.get() ).getJson() );
    ...
    public void naoDeveRetornarUmaRacaTest() throws Exception {
        // Cenário
        String temperamento = "temperamentoInexistente";
        BDDMockito.given( racaService.buscarPeloTemperamento(Mockito.anyString()) ).willReturn( Optional.empty() );
